...
var allInfo = [
    {
      "id": "4bf44b07-1e41-48bf-bbf1-7a91f2b94971",
      "name": "blue Husky",
      "temperament": [
        "Happy",
        "Loyal",
      ...
      "life_span": "100",
      "createdInDb": true,
      "image": "https://scontent.feoh3-1.fna.fbcdn.net/v/t1.6435-9/189153267_4538599576167567_9091395709940576537_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=e3f864&_nc_ohc=z6t6cCNd01IAX_k5Tn8&_nc_ht=scontent.feoh3-1.fna&oh=00_AT80XiAHo0KS5uH-nnyDYM8SeLvvU1XXEw1NtYHxOnpoPw&oe=6246DA49"
    },
    {
      "id": "c00588bd-7788-403a-9edc-8d2e969fe70f",
      "name": "zacha",
      "temperament": [
        "Loving"
      ],
    ...
    {
      "id": "9aacca55-72ec-43a5-a89b-7c1f006bac91",
      "name": "Luna",
      "temperament": [
        "Independent"
      ],
    ...
    {
      "id": "0e69c469-3385-457b-beaf-000a7e02c820",
      "name": "rudiger",
      "temperament": [
        "Independent"
      ],
  ...
  // necesito tener en la posicion [0] el peso minimo y en la posicion [1] el peso maximo 

  // me traigo todos los pesos
var weight = allInfo.map( el => el.weight.split('-')) // aca tengo un arrar de esta forma
